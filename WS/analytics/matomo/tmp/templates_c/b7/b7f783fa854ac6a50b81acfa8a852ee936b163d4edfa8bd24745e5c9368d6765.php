...
class __TwigTemplate_1a09b82b6df19333b3dd01fc64533a38255eea9c221d3b89ebfdfeafc4bbd0db extends Template
{
    private $source;
    private $macros = [];
...
";
        // line 21
        if ( !twig_test_empty((((isset($context["unsubscribeLink"]) || array_key_exists("unsubscribeLink", $context))) ? (_twig_default_filter((isset($context["unsubscribeLink"]) || array_key_exists("unsubscribeLink", $context) ? $context["unsubscribeLink"] : (function () { throw new RuntimeError('Variable "unsubscribeLink" does not exist.', 21, $this->source); })()))) : ("")))) {
            // line 22
            echo "    ";
            ob_start();
...
", "@CoreHome/_htmlEmailFooter.twig", "/var/www/html/nes/analytics/matomo/plugins/CoreHome/templates/_htmlEmailFooter.twig");
    }
}
