...
class __TwigTemplate_cc4ceee2f565912c8137758cd500c9c99abe29d8c740d0246eb2aa3f99007a0c extends Template
{
    private $source;
    private $macros = [];
    ...
    {
        return new Source("<br />{{ 'GeoIp2_GeoIPVariablesConfigurationHere'|translate('<a href=\"' ~ configUrl|e('html_attr') ~ '\">', '</a>')|raw }}", "@GeoIp2/serverModule.twig", "/var/www/html/nes/analytics/matomo/plugins/GeoIp2/templates/serverModule.twig");
    }
}
