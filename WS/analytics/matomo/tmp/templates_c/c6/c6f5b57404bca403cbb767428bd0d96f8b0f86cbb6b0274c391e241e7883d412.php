...
class __TwigTemplate_655d7955db64c1dd90ca2111d025b289944bb1483fa5be0c0df8a44d11e42af9 extends Template
{
    private $source;
    private $macros = [];
...
";
        ...
        echo \Piwik\piwik_escape_filter($this->env, (((isset($context["date"]) || array_key_exists("date", $context))) ? (_twig_default_filter((isset($context["date"]) || array_key_exists("date", $context) ? $context["date"] : (function () { throw new RuntimeError('Variable "date" does not exist.', 42, $this->source); })()), (((isset($context["endDate"]) || array_key_exists("endDate", $context))) ? (_twig_default_filter((isset($context["endDate"]) || array_key_exists("endDate", $context) ? $context["endDate"] : (function () { throw new RuntimeError('Variable "endDate" does not exist.', 42, $this->source); })()), "")) : ("")))) : ((((isset($context["endDate"]) || array_key_exists("endDate", $context))) ? (_twig_default_filter((isset($context["endDate"]) || array_key_exists("endDate", $context) ? $context["endDate"] : (function () { throw new RuntimeError('Variable "endDate" does not exist.', 42, $this->source); })()), "")) : ("")))), "html", null, true);
        echo "\";
";
        // line 43
...
";
    ...
    piwik.userCapabilities = ";
        // line 56
        echo json_encode((((isset($context["userCapabilities"]) || array_key_exists("userCapabilities", $context))) ? (_twig_default_filter((isset($context["userCapabilities"]) || array_key_exists("userCapabilities", $context) ? $context["userCapabilities"] : (function () { throw new RuntimeError('Variable "userCapabilities" does not exist.', 56, $this->source); })()), [])) : ([])));
        echo ";
    piwik.config = {};
";
        // line 58
...
", "_jsGlobalVariables.twig", "/var/www/html/nes/analytics/matomo/plugins/Morpheus/templates/_jsGlobalVariables.twig");
    }
}
