...
class __TwigTemplate_6f6ea8743bdfc1f76aadfa947ded86e1a1f754db3512ff289e3f52bdfe50a73e extends Template
{
    private $source;
    private $macros = [];
...
(isset($context["idSubtable"]) || array_key_exists("idSubtable", $context))) ? (_twig_default_filter((isset($context["idSubtable"]) || array_key_exists("idSubtable", $context) ? $context["idSubtable"] : (function () { throw new RuntimeError('Variable "idSubtable" does not exist.', 4, $this->source); })()), false)) : (false)));
        // line 5
...
{% else %}
    ...
    {%- endif -%}
{% endif %}", "@CoreVisualizations/_dataTableViz_htmlTable.twig", "/var/www/html/nes/analytics/matomo/plugins/CoreVisualizations/templates/_dataTableViz_htmlTable.twig");
    }
}
