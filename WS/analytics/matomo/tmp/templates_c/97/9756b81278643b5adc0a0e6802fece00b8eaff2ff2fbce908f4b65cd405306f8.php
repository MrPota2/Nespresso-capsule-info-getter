...
class __TwigTemplate_5f056d9d2f65b801a03b66a3ca68dfab50c55a3d3d47a8091b282802835f752b extends Template
{
    private $source;
    private $macros = [];
...
";
        // line 2
        if (((isset($context["formErrors"]) || array_key_exists("formErrors", $context)) &&  !twig_test_empty((isset($context["formErrors"]) || array_key_exists("formErrors", $context) ? $context["formErrors"] : (function () { throw new RuntimeError('Variable "formErrors" does not exist.', 2, $this->source); })())))) {
            // line 3
...
{% endif %}
", "@Login/_formErrors.twig", "/var/www/html/nes/analytics/matomo/plugins/Login/templates/_formErrors.twig");
    }
}
