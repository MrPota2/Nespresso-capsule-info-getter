...
class __TwigTemplate_ac13fd2902a97e71c76d73e4c06352b649a914f837c03156cbcbb31be000f5bf extends Template
{
    private $source;
    private $macros = [];
...
<div class=\"card-content\">
    ";
            ...
            ";
                    ...
                    if ((isset($context["reportLastUpdatedMessage"]) || array_key_exists("reportLastUpdatedMessage", $context))) {
...
";
            ...
            echo " ";
            if ((((isset($context["isComparing"]) || array_key_exists("isComparing", $context))) ? (_twig_default_filter((isset($context["isComparing"]) || array_key_exists("isComparing", $context) ? $context["isComparing"] : (function () { throw new RuntimeError('Variable "isComparing" does not exist.', 33, $this->source); })()), false)) : (false))) {
                echo "isComparing";
            }
            echo "\"
     data-table-type=\"";
    ...
    <div class=\"reportDocumentation\" data-content=\"";
        ...
        ";
            ...
            // line 47
            echo "        ";
            if (((isset($context["reportLastUpdatedMessage"]) || array_key_exists("reportLastUpdatedMessage", $context)) && (isset($context["reportLastUpdatedMessage"]) || array_key_exists("reportLastUpdatedMessage", $context) ? $context["reportLastUpdatedMessage"] : (function () { throw new RuntimeError('Variable "reportLastUpdatedMessage" does not exist.', 47, $this->source); })()))) {
...
(isset($context["showPluginArchiveDisabled"]) || array_key_exists("showPluginArchiveDisabled", $context)) && (isset($context["showPluginArchiveDisabled"]) || array_key_exists("showPluginArchiveDisabled", $context) ? $context["showPluginArchiveDisabled"] : (function () { throw new RuntimeError('Variable "showPluginArchiveDisabled" does not exist.', 62, $this->source); })()))) {
                        // line 63
                        echo "                    ";
...
{%- endif %}
", "@CoreHome/_dataTable.twig", "/var/www/html/nes/analytics/matomo/plugins/CoreHome/templates/_dataTable.twig");
    }
}
