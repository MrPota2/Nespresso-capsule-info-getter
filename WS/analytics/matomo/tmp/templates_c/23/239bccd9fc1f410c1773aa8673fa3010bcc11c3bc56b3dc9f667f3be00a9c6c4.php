...
/* contentBlock.twig */
class __TwigTemplate_a2ccf5ceccffc6fd08120aed532d239b31079d77625c50cb3ae4a243bbd6358e extends Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"card-content\">
        ";
        // line 3
        if (((isset($context["title"]) || array_key_exists("title", $context)) && (isset($context["title"]) || array_key_exists("title", $context) ? $context["title"] : (function () { throw new RuntimeError('Variable "title" does not exist.', 3, $this->source); })()))) {
            // line 4
            echo "            <h2 class=\"card-title\"
                  ";
            // line 5
            if ((((isset($context["rate"]) || array_key_exists("rate", $context)) && (isset($context["rate"]) || array_key_exists("rate", $context) ? $context["rate"] : (function () { throw new RuntimeError('Variable "rate" does not exist.', 5, $this->source); })())) && $this->env->getTest('true')->getCallable()((isset($context["rate"]) || array_key_exists("rate", $context) ? $context["rate"] : (function () { throw new RuntimeError('Variable "rate" does not exist.', 5, $this->source); })())))) {
...
</div>", "contentBlock.twig", "/var/www/html/nes/analytics/matomo/plugins/Morpheus/templates/contentBlock.twig");
    }
}
