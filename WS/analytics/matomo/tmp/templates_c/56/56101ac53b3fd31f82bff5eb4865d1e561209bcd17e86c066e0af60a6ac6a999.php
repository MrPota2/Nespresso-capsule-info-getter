...
/* macros.twig */
class __TwigTemplate_fb88f44a918668eb4bdd1c5e84559242ae0a920bd88be5449f704e98c12a7c1f extends Template
{
    private $source;
    private $macros = [];
    ...
    public function macro_logoHtml($__metadata__ = null, $__alt__ = "", ...$__varargs__)
    {
        ...
        try {
            ...
            if (twig_get_attribute($this->env, $this->source, ($context["metadata"] ?? null), "logo", [], "array", true, true, false, 2)) {
                ...
                echo " ";
                echo \Piwik\piwik_escape_filter($this->env, (((isset($context["width"]) || array_key_exists("width", $context))) ? (_twig_default_filter((isset($context["width"]) || array_key_exists("width", $context) ? $context["width"] : (function () { throw new RuntimeError('Variable "width" does not exist.', 15, $this->source); })()), "")) : ("")), "html", null, true);
                echo " ";
                echo \Piwik\piwik_escape_filter($this->env, (((isset($context["height"]) || array_key_exists("height", $context))) ? (_twig_default_filter((isset($context["height"]) || array_key_exists("height", $context) ? $context["height"] : (function () { throw new RuntimeError('Variable "height" does not exist.', 15, $this->source); })()), "")) : ("")), "html", null, true);
                echo " src='";
...
{% endmacro %}", "macros.twig", "/var/www/html/nes/analytics/matomo/plugins/Morpheus/templates/macros.twig");
    }
}
