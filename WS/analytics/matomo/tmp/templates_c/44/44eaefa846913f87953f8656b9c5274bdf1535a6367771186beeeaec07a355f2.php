...
/* ajaxMacros.twig */
class __TwigTemplate_e3d6005584984b3595971e587888aa7e4929857db3396e0d43316e2def778728 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    public function macro_requestErrorDiv($__contactEmail__ = null, $__areAdsForProfessionalServicesEnabled__ = false, $__currentModule__ = "", $__showMoreHelp__ = false, ...$__varargs__)
    {
        ...
        <div class=\"alert alert-danger\">
            ";
            // line 19
            if (((isset($context["contactEmail"]) || array_key_exists("contactEmail", $context)) && (isset($context["contactEmail"]) || array_key_exists("contactEmail", $context) ? $context["contactEmail"] : (function () { throw new RuntimeError('Variable "contactEmail" does not exist.', 19, $this->source); })()))) {
                // line 20
                echo "                ";
...
{% endmacro %}
", "ajaxMacros.twig", "/var/www/html/nes/analytics/matomo/plugins/Morpheus/templates/ajaxMacros.twig");
    }
}
