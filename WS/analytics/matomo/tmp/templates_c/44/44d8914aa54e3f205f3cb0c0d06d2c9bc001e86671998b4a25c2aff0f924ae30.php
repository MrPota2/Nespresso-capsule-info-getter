...
class __TwigTemplate_48b28762034e70d5339147675b104bb15ec835fa14d158de5bb6794f68bde3a5 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    <section class=\"loginSection row\">
        ...
        // line 36
        echo "        ";
        if ((((isset($context["isValidHost"]) || array_key_exists("isValidHost", $context)) && (isset($context["invalidHostMessage"]) || array_key_exists("invalidHostMessage", $context))) && (0 === twig_compare((isset($context["isValidHost"]) || array_key_exists("isValidHost", $context) ? $context["isValidHost"] : (function () { throw new RuntimeError('Variable "isValidHost" does not exist.', 36, $this->source); })()), false)))) {
            // line 37
            echo "            ";
...
{% endblock %}
", "@Login/loginLayout.twig", "/var/www/html/nes/analytics/matomo/plugins/Login/templates/loginLayout.twig");
    }
}
