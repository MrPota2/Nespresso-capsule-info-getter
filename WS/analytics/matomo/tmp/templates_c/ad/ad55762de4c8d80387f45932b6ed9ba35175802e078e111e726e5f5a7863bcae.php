...
class __TwigTemplate_9859971caaacb37d9c8fda4fef48a8aca2ba684dbeb27eb620f7d6ff1f62f741 extends Template
{
    private $source;
    private $macros = [];
...
<table style=\"width:100%; background-color: ";
    ...
    <tr>
        ...
        <td align=\"right\">
            ";
        // line 25
        if ( !twig_test_empty((((isset($context["idSite"]) || array_key_exists("idSite", $context))) ? (_twig_default_filter((isset($context["idSite"]) || array_key_exists("idSite", $context) ? $context["idSite"] : (function () { throw new RuntimeError('Variable "idSite" does not exist.', 25, $this->source); })()))) : ("")))) {
            // line 26
            echo "            <a style=\"";
            ...
            echo "\" ";
            if ( !twig_test_empty((((isset($context["websiteName"]) || array_key_exists("websiteName", $context))) ? (_twig_default_filter((isset($context["websiteName"]) || array_key_exists("websiteName", $context) ? $context["websiteName"] : (function () { throw new RuntimeError('Variable "websiteName" does not exist.', 26, $this->source); })()))) : ("")))) {
                echo "title=\"";
            ...
            echo $this->env->getFunction('linkTo')->getCallable()(["module" => "CoreHome", "action" => "redirectToCoreHomeIndex", "idSite" => (isset($context["idSite"]) || array_key_exists("idSite", $context) ? $context["idSite"] : (function () { throw new RuntimeError('Variable "idSite" does not exist.', 26, $this->source); })()), "period" => (((isset($context["period"]) || array_key_exists("period", $context))) ? (_twig_default_filter((isset($context["period"]) || array_key_exists("period", $context) ? $context["period"] : (function () { throw new RuntimeError('Variable "period" does not exist.', 26, $this->source); })()))) : ("")), "date" => (((isset($context["date"]) || array_key_exists("date", $context))) ? (_twig_default_filter((isset($context["date"]) || array_key_exists("date", $context) ? $context["date"] : (function () { throw new RuntimeError('Variable "date" does not exist.', 26, $this->source); })()))) : ("")), "token_auth" => null, "method" => null, "idReport" => null, "outputType" => null, "format" => null]);
            echo "\">
                ";
            // line 27
...
<div style=\"margin:0 20px 25px 20px;\">
", "@CoreHome/_htmlEmailHeader.twig", "/var/www/html/nes/analytics/matomo/plugins/CoreHome/templates/_htmlEmailHeader.twig");
    }
}
