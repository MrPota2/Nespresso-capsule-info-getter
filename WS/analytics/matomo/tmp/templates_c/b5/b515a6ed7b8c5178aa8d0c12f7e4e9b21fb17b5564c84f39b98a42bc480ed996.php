...
class __TwigTemplate_763c333656b9f54c5da7966d5dfd95844453e4b80e1dedf9bf62cf58fbc445f9 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    ";
            // line 15
            if ((0 !== twig_compare(twig_get_attribute($this->env, $this->source, (isset($context["visitInfo"]) || array_key_exists("visitInfo", $context) ? $context["visitInfo"] : (function () { throw new RuntimeError('Variable "visitInfo" does not exist.', 15, $this->source); })()), "getColumn", [0 => "location"], "method", false, false, false, 15), $this->env->getFilter('translate')->getCallable()("General_Unknown")))) {
...
{% endif %}
", "@Live/_visitorDetails.twig", "/var/www/html/nes/analytics/matomo/plugins/Live/templates/_visitorDetails.twig");
    }
}
