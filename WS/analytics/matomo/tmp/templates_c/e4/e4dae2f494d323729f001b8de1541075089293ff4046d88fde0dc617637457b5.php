...
class __TwigTemplate_1ae5f6f1b95b12f9edf1621cf7a5af0afde991b8ebf3a8237389312ab69e20b1 extends Template
{
    private $source;
    private $macros = [];
...
<script>\$(document).ready(function () { require('{{ jsNamespace }}').{{ jsClass }}.initElements(); });</script>", "@CoreHome\\_uiControl.twig", "/var/www/html/nes/analytics/matomo/plugins/CoreHome/templates/_uiControl.twig");
    }
}
