...
class __TwigTemplate_0d33442a2498c333cc42b7f100b4c39616ed44949a69e80db522f648872cd4e1 extends Template
{
    private $source;
    private $macros = [];
...
<div class=\"container\">
    ...
    <div class=\"row\">
        ...
        // line 62
        echo "            ";
        if (((isset($context["showNextStepAtTop"]) || array_key_exists("showNextStepAtTop", $context)) && (isset($context["showNextStepAtTop"]) || array_key_exists("showNextStepAtTop", $context) ? $context["showNextStepAtTop"] : (function () { throw new RuntimeError('Variable "showNextStepAtTop" does not exist.', 62, $this->source); })()))) {
            // line 63
            echo "                ";
...
", "@Installation/layout.twig", "/var/www/html/nes/analytics/matomo/plugins/Installation/templates/layout.twig");
    }
}
